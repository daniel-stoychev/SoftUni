          ...
          <div className="col-lg-6 align-self-center">
            <div className="header-text">
              ...
              <p>
                ...
                your NFT websites. This HTML CSS template is based on Bootstrap
                v5 and it is designed for NFT related web portals. Liberty can
                be freely downloaded from TemplateMo's free css templates.
              </p>
